...
if __name__ == "__main__":
    ...
    while not either_exit:
        ...
        if (my_grid.iguana_escaped):
            ...
            print("The iguana ran out of energy (>100 steps). The snakes are victorious... (loss)")
            either_exit = True
        current_steps += 1
    ...
    if (generate_metrics):
        ...
        for i in range(10000):
            my_grid = GridClassFile.GridEnvironment(size=11, num_snakes=5, do_print=False)
            ...
            while not either_exit:
                ...
                if (my_grid.iguana_escaped):
                    ...
                    either_exit = True
                current_steps += 1
        print("Wins:", num_victories, "Losses:", num_losses, "Win Ratio:", num_victories/num_losses, "Win Percent:", round(num_victories/10000.0*100, 4))
